    ...
    <body>
        ...
        <header class="header">
            ...
            <div class="main-baner">
                ...
                <div class="background parallax clearfix" style="background-image:url('{{ URL::asset('/') }}img/tumblr_n7yhhvUQtx1st5lhmo1_1280.jpg');" data-img-width="1600" data-img-height="1064">
                                        ...
                                        <div class="col-md-4 col-sm-8 col-xs-12">
                                            ...
                                            <nav id="nav" class="main-navigation">
                                                ...
                                                <ul class="navigation">
                                                    ...
                                                    <li>
                                                        <a href="{{URL::Route('view-message')}}">View messages</a>
                                                    </li>
                                                    <li>
